...
final class FeaturesGuideViewController: TableViewController {
    ...
    private let sections: [Section] = [
        ...
        Section(header: NSLocalizedString("Packs", comment: "Guide section header"),
                ...
                items: [
                    Item(title: NSLocalizedString("Built-in packs", comment: "Guide item title"),
                         detail: NSLocalizedString("Math, Finance, Symbols and Programmer give one-tap operators and symbols.", comment: "Guide item detail")),
                    Item(title: NSLocalizedString("New in 2.0", comment: "Guide item title"),
                         detail: NSLocalizedString("Units & Conversion, Scientific, Date & Time (inserts live values), Business, International, and Programmer+.", comment: "Guide item detail")),
                ]),
        ...
        Section(header: NSLocalizedString("Customizable Keyboard", comment: "Guide section header"), footer: nil,
                items: [
                    Item(title: NSLocalizedString("Design your own layout", comment: "Guide item title"),
                         detail: NSLocalizedString("Custom Keyboard lets you drag, add and remove keys to build your own grid. Included with Pro.", comment: "Guide item detail")),
                ]),
