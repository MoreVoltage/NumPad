...
extension StoreViewController {
    ...
    private var controlToggles: [ToggleRow] {
        [
            ...
            ToggleRow(image: "keyboard", title: NSLocalizedString("Pack Switch Shortcut", comment: "Store toggle: turns the next key into a quick pack switcher (was 'Repurpose Next Key')"),
            ...
            ToggleRow(image: "keyboard", title: NSLocalizedString("Auto-Match Pack to Field", comment: "Store toggle: auto-picks a pack to match the text field (was 'Smart Pack Defaulting')"),
