...
//    }
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        Analytics.logCustomEvent(name: "session", attributes: ["isReversedMode": Keyboard.isReversedMode.hashValue, "keyboardType": KeyboardType.selected.rawValue, "keyboardTheme": KeyboardTheme.selected.rawValue])
    }
