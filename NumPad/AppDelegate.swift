...
//    }
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        Analytics.logCustomEvent(name: "session", attributes: ["isNightMode": Keyboard.isNightMode.hashValue, "isReversedMode": Keyboard.isReversedMode.hashValue, "keyboardType": KeyboardType.selected.rawValue, "keyboardTheme": KeyboardTheme.selected.rawValue])
    }
